...
def analytics_page() -> None:
    ...
    with chart_a:
        ...
        if px:
            ...
            st.plotly_chart(fig, use_container_width=True, key="analytics_chart_1")
        else:
    ...
    with chart_b:
        ...
        if error_df.empty:
            ...
            st.plotly_chart(fig, use_container_width=True, key="analytics_chart_2")
        else:
    ...
    with chart_c:
        ...
        if px:
            ...
            fig.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
            st.plotly_chart(fig, use_container_width=True, key="analytics_chart_3")
        else:
    ...
    with chart_d:
        ...
        if communication_df.empty:
            ...
            fig.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
            st.plotly_chart(fig, use_container_width=True, key="analytics_chart_4")
        else:
